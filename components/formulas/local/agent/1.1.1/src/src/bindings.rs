...
pub mod cyfr {
    pub mod formula {
        ...
        pub mod invoke {
            ...
            #[allow(unused_unsafe, clippy::all)]
            /// Fire-and-forget: push an intermediate event to subscribers.
            /// The json-event string is broadcast via PubSub to any listeners
            /// (SSE clients, LiveView, CLI). Never blocks.
            /// Response: {"ok": true, "sequence": N}
            pub fn emit(json_event: &str) -> _rt::String {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod cyfr {
        pub mod formula {
            ...
            pub mod run {
                ...
                #[doc(hidden)]
                macro_rules! __export_cyfr_formula_run_0_1_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "cyfr:formula/run@0.1.0#run")] unsafe extern "C" fn
                        export_run(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_run_cabi::<$ty > (arg0, arg1) } }
                        #[unsafe (export_name = "cabi_post_cyfr:formula/run@0.1.0#run")]
                        unsafe extern "C" fn _post_return_run(arg0 : * mut u8,) { unsafe
                        { $($path_to_types)*:: __post_return_run::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_cyfr_formula_run_0_1_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_formula_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::cyfr::formula::run::__export_cyfr_formula_run_0_1_0_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::cyfr::formula::run);
    };
}
#[doc(inline)]
pub(crate) use __export_formula_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:cyfr:formula@0.1.0:formula:encoded world"
)]
#[doc(hidden)]
...
A\x04\x01B\x0b\x01@\x01\x0cjson-requests\0s\x04\0\x04call\x01\0\x04\0\x05spawn\x01\
\0\x01@\x01\x07task-ids\0s\x04\0\x05await\x01\x01\x04\0\x09await-all\x01\0\x04\0\
\x09await-any\x01\0\x04\0\x04poll\x01\x01\x04\0\x06cancel\x01\x01\x01@\x01\x0ajs\
on-events\0s\x04\0\x04emit\x01\x02\x03\0\x19cyfr:formula/invoke@0.1.0\x05\0\x01B\
\x02\x01@\x01\x05inputs\0s\x04\0\x03run\x01\0\x04\0\x16cyfr:formula/run@0.1.0\x05\
\x01\x04\0\x1acyfr:formula/formula@0.1.0\x04\0\x0b\x0d\x01\0\x07formula\x03\0\0\0\
