...
cyfr secret set SUPABASE_ANON_KEY=your-anon-key
cyfr secret set SUPABASE_SERVICE_ROLE_KEY=your-service-role-key
cyfr secret grant c:local.supabase SUPABASE_URL
cyfr secret grant c:local.supabase SUPABASE_ANON_KEY
cyfr secret grant c:local.supabase SUPABASE_SERVICE_ROLE_KEY
```
